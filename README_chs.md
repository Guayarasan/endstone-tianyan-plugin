...
#### 查看在线玩家物品栏功能
天眼插件支持查看在线玩家的物品栏内的物品信息。默认使用文本表单展示。如果安装了可选的 [endstone-inventoryui](https://github.com/yuhangle/endstone-inventoryui) 插件，`/tyo` 将以可视化箱子界面展示物品栏，附魔光泽和自定义名称均可正确渲染。
...
/tyo 玩家名
```
默认使用文本表单展示。如果安装了可选的 [endstone-inventoryui](https://github.com/yuhangle/endstone-inventoryui) 插件，将打开可视化箱子界面。注意：鼠标悬停时的物品 tooltip 受客户端限制，不会显示附魔详情。
